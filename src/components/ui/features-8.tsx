                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-zinc-900 border-zinc-800">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    <svg
                                        className="text-zinc-600 absolute inset-0 size-full"
                                        viewBox="0 0 254 104"
                                        fill="none"
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-zinc-900 border-zinc-800">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-zinc-700 before:absolute before:-inset-2 before:rounded-full before:border before:border-zinc-800">
                                    <Shield className="m-auto size-12 text-blue-400" />
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-zinc-900 border-zinc-800">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <div className="w-full h-[123px] rounded-[10px] bg-zinc-800 flex items-center justify-center border border-zinc-700">
                                        <span className="text-zinc-400">Server Status: Online</span>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-zinc-900 border-zinc-800">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-zinc-700 before:absolute before:-inset-2 before:rounded-full before:border before:border-zinc-800">
                                        <Shield
                                            className="m-auto size-5 text-zinc-300"
                                            strokeWidth={1}
                                        />
                                    </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-zinc-900 border-zinc-800">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-zinc-700 before:absolute before:-inset-2 before:rounded-full before:border before:border-zinc-800">
                                        <Users
                                            className="m-auto size-6 text-zinc-300"
                                            strokeWidth={1}
                                        />
                                    </div>
                                    <div className="space-y-2">
