...
export function HoverFooter() {
    ...
    const contactInfo = [
        {
            ...
            text: "hello@ethicworks.com",
            href: "mailto:hello@ethicworks.com",
        },
        {
    ...
    return (
        <footer className="bg-black w-full relative h-fit overflow-hidden border-t border-white/10">
            <div className="max-w-7xl mx-auto p-14 z-40 relative">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 lg:gap-16 pb-12">
                    ...
                    <div className="flex flex-col space-y-4">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-white text-3xl font-bold">Ethic Works</span>
                        </div>
                        <p className="text-sm leading-relaxed text-zinc-400">
                            Ethic Works is a modern React and Next.js based UI component library.
                        </p>
                    </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center text-sm space-y-4 md:space-y-0 text-zinc-400">
                    ...
                    <p className="text-center md:text-left text-zinc-400">
                        &copy; {new Date().getFullYear()} Ethic Works. All rights reserved.
                    </p>
                </div>
            </div >
            ...
            < div className="lg:flex hidden h-[30rem] -mt-52 -mb-36" >
                <TextHoverEffect text="Ethic Works" className="z-50" />
            </div >
